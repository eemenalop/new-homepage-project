    ...
    <section>
      ...
      <div className='sm:flex'>
        ...
        <div className='flex-1 pt-9'>
          <p className='text-[10px] mb-10 sm:text-[15px]'>We dive into the next evolution of the web that claims to put the power of the platforms back into the hands of the people. 
